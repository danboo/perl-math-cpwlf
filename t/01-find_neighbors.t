...
my @tests =
   ...
   [ 'one - left out of bounds',  [ 0, 0 ],         [ 1 ],   0,   undef, undef ],
   [ 'one - right out of bounds', [ 0, 0 ],         [ 1 ],   2,   undef, undef ],

   [ 'two - left direct',         [ 0, 0 ],         [ 1,2 ], 1,   undef, undef ],
   [ 'two - right direct',        [ 1, 1 ],         [ 1,2 ], 2,   undef, undef ],
   [ 'two - left out of bounds',  [ 0, 0 ],         [ 1,2 ], 0,   undef, undef ],
   [ 'two - right out of bounds', [ 1, 1 ],         [ 1,2 ], 3,   undef, undef ],
   ...
   [ 'three - left out of bounds',  [ 0, 0 ],         [ 1,2,3 ], 0,   undef, undef ],
   [ 'three - right out of bounds', [ 2, 2 ],         [ 1,2,3 ], 4,   undef, undef ],
